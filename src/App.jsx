...
const CLIENT = { name:'Mariam Koné', brand:'Luminara Beauty', plan:'Conversion Starter', avatar:'MK', total:63 };

const PLAN_QUANTITY = { 'Conversion Starter':9, 'Conversion Pro':18, 'Conversion Scale':36 };

const ANGLES = ['Douleur sociale','Transformation rapide','Preuve sociale'];

const CREA = Array.from({length:15},(_,i)=>({
  id:i+1, angle:ANGLES[i%3], week:`S${Math.ceil((i+1)/3)}`, productId:1,
  g1:['#3A0808','#0A1A3A','#0A2A1A','#3A2A08','#2A083A'][i%5],
  g2:['#1A0404','#EED8B0','#143A14','#1A1208','#180428'][i%5],
}));

const INITIAL_PRODUCTS = [
  {
    id:1, nom:'Sérum Éclat Intense', pricing:'12 900 FCFA', promo:'',
    lien:'', utilite:"Unifie le teint et booste l'éclat naturel en 21 jours",
    cible:'Femmes 22-40 ans, peaux ternes marquées par la fatigue',
    pays:'Sénégal', notes:'', photo:null, logo:null,
    couleur1:'#2D7FF9', couleur2:'#FFFFFF',
    deliveries:[
      {
        semaine:1, date:'08 Jan 2025',
        angles:[
          {
            numero:1, nom:'Douleur sociale',
            hooks:["Ton teint terne te coûte des opportunités chaque jour","Tu t'illumines pour les autres, jamais pour toi ?","Voilà pourquoi les femmes autour de toi brillent plus","Le secret de teint que les dakaroises gardent bien","21 jours. Après, ton miroir te dira merci"],
            body:`Tu sors d'un meeting important. Tu croises ton reflet dans une vitrine — et là, tu vois ce que les autres voient : un teint fatigué, qui ne te représente pas.\n\nÇa fait des mois que tu essaies des crèmes locales, des conseils TikTok... Sans résultat durable.\n\nLe Sérum Éclat Intense de Luminara change ça. Formulé avec 3 actifs testés sur peaux africaines, il agit dès la 1ère semaine.\n\nLivraison au Sénégal · Wave / Orange Money · Résultats garantis 21 jours.`,
          },
          {
            numero:2, nom:'Transformation rapide',
            hooks:["21 jours pour un teint que tu mérites vraiment","De terne à lumineuse — le chrono commence maintenant","Les femmes qui ont essayé ne reviennent plus jamais en arrière","1 sérum. 3 semaines. 1 transformation visible au miroir","Pendant que tu lis ça, d'autres commandent déjà"],
            body:`Ce n'est pas une promesse. C'est de la science.\n\nEn 21 jours, le Sérum Éclat Intense unifie le teint, réduit les taches sombres, booste l'éclat naturel — même sous la chaleur de Dakar.\n\nDes centaines de femmes ont documenté leur transformation semaine après semaine.\n\nLivrée demain dans la zone de Dakar · Wave / Orange Money.`,
          },
          {
            numero:3, nom:'Preuve sociale',
            hooks:['"Je ne mets plus de fond de teint" — Fatou, Dakar',"+847 femmes en Afrique de l'Ouest ont déjà changé de peau","Avant/après réels — aucun filtre, aucun Photoshop","Le N°1 recommandé dans les groupes beauté sénégalais","Pourquoi les influenceuses ne parlent que de ça en ce moment"],
            body:`Quand Aminata a reçu son premier flacon, elle était sceptique.\n\n3 semaines plus tard, elle nous a envoyé des avant/après non retouchés. Son entourage demandait son secret.\n\n+847 femmes en Afrique de l'Ouest. Même transformation.\n\nFormule développée spécifiquement pour les peaux à mélanine.\n\nWave / Orange Money · Livraison J+1 Dakar.`,
          },
        ],
      },
      {
        semaine:2, date:'15 Jan 2025',
        angles:[
          {
            numero:4, nom:'Urgence et rareté',
            hooks:["Stock limité — les derniers flacons s'envolent","7 femmes commandent ce sérum chaque heure à Dakar","Ne laisse pas une autre prendre ta place","Pendant que tu hésites, ton teint attend","Commande ce soir, reçois demain avant 18h"],
            body:`Les flacons du Sérum Éclat Intense fondent. Et ce n'est pas un hasard.\n\nChaque semaine, des centaines de femmes à travers le Sénégal font confiance à cette formule.\n\nStock disponible limité cette semaine. Livraison J+1 garantie sur Dakar.\n\nCommande maintenant — Wave / Orange Money acceptés.`,
          },
          {
            numero:5, nom:'Crédibilité scientifique',
            hooks:["3 actifs prouvés. 21 jours. 1 teint transformé","Ce que les dermatologues recommandent aux peaux africaines","Pas de filtre. Pas de mensonge. Juste de la science","La formule qu'on a mis 2 ans à perfectionner pour toi","94% des testées ont vu la différence en 21 jours"],
            body:`La beauté, ce n'est pas de la magie. C'est de la science appliquée.\n\nLe Sérum Éclat Intense contient 3 actifs cliniquement testés sur peaux à mélanine : Niacinamide 5%, Vitamine C stabilisée, Acide kojique naturel.\n\nRésultat : teint unifié, taches estompées, éclat amplifié — visible en 21 jours ou remboursé.\n\nLivraison partout au Sénégal · Wave / Orange Money.`,
          },
          {
            numero:6, nom:'Comparaison produits',
            hooks:["Pourquoi payer 3 produits quand 1 fait tout ?","Les crèmes du marché coûtent plus. Donnent moins","Tu mérites mieux que ce que les autres te vendent","Voilà pourquoi les femmes abandonnent les autres marques","Un seul sérum remplace ta routine complète"],
            body:`Combien dépenses-tu chaque mois en produits qui ne donnent rien ?\n\nFond de teint. Correcteur. Crème éclat. Masque. Le total monte vite.\n\nLe Sérum Éclat Intense remplace tout ça. Un geste matin et soir — résultats visibles en 21 jours.\n\nEt il coûte moins cher que ta routine actuelle.\n\nLivraison au Sénégal · Wave / Orange Money.`,
          },
        ],
      },
    ],
    marche: {
      persona: {
        nom: 'Kadidjatou, 28 ans',
        role: 'Comptable PME · Dakar, Plateau',
        revenu: '350–500k FCFA/mois',
        quote: '"Elle se retrouve chaque matin face à son miroir, à appliquer 3 produits sans résultat visible. En meeting, elle remarque les teints lumineux de ses collègues et sent que le sien parle avant elle."',
        platforms: ['TikTok','WhatsApp','Instagram'],
      },
      stats: [
        {l:'Taille marché cible',v:'12M femmes',s:'22–40 ans · Afrique francophone',c:null},
        {l:'Meilleur angle actuel',v:'Douleur sociale',s:'CTR 3.4% · +40% vs moyenne',c:'red'},
        {l:'Panier moyen estimé',v:'28 000 F',s:'FCFA par commande',c:null},
        {l:'Concurrence Meta',v:'3 acteurs actifs',s:'Niveau moyen · fenêtre ouverte',c:null},
      ],
      insights: [
        {icon:'image',t:'Les créatives avec skin close-up performent 40% mieux sur votre audience'},
        {icon:'clock',t:"Pic d'engagement 19h–22h — concentrez votre budget sur ce créneau"},
        {icon:'card',t:'Le mot "Wave" dans le CTA augmente le taux de clic de 18%'},
        {icon:'phone',t:'Format vidéo 3–5s outperform les statiques sur mobile Dakar'},
      ],
    },
  },
];
...
const NAV = [
  {id:'demo',icon:'eye',label:'Voir Démo'},
  ...
  {id:'amina',icon:'sparkle',label:'Assistant IA'},
...
const Sidebar = ({active, set, isDemo, setDemo, collapsed, setCollapsed, isMobile, mobileOpen, setMobileOpen}) => {
  ...
  const asideStyle = isMobile
    ? {position:'fixed',top:0,left:0,height:'100%',zIndex:500,width:'min(80vw,272px)',background:C.sidebar,borderRight:`1px solid ${C.border}`,display:'flex',flexDirection:'column',overflow:'hidden',transform:mobileOpen?'translateX(0)':'translateX(-100%)',transition:'transform 0.25s ease',boxShadow:mobileOpen?'8px 0 30px rgba(0,0,0,0.45)':'none'}
  ...
  <aside style={asideStyle}>
    <div style={{padding:showCollapsed?'14px 0':'14px 14px 0',display:'flex',justifyContent:showCollapsed?'center':'flex-end'}}>
      <button
        onClick={() => isMobile ? setMobileOpen(false) : setCollapsed(!collapsed)}
        title={isMobile ? 'Fermer le menu' : (showCollapsed?'Ouvrir le menu':'Réduire le menu')}
        style={{width:30,height:30,borderRadius:7,border:'none',background:'rgba(255,255,255,0.07)',color:C.sec,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,transition:'background 0.15s'}}
        onMouseEnter={e=>e.currentTarget.style.background='rgba(255,255,255,0.08)'}
        onMouseLeave={e=>e.currentTarget.style.background='rgba(255,255,255,0.07)'}
      >
        <Icon name={isMobile?'x':'menu'} size={14} color={C.sec}/>
      </button>
    </div>

    <div style={{padding:showCollapsed?'10px 0 14px':'10px 18px 14px',borderBottom:`1px solid ${C.border}`,display:'flex',alignItems:'center',justifyContent:showCollapsed?'center':'flex-start',gap:9}}>
    ...
    <div style={{padding:showCollapsed?'12px 0':'12px 16px',borderBottom:`1px solid ${C.border}`,display:'flex',alignItems:'center',justifyContent:showCollapsed?'center':'flex-start',gap:10}}>
      <div title={showCollapsed?CLIENT.brand:undefined} style={{width:32,height:32,borderRadius:8,flexShrink:0,background:'rgba(45,127,249,0.18)',border:'1px solid rgba(45,127,249,0.28)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:11,fontWeight:700,color:C.red}}>{CLIENT.avatar}</div>
      {!showCollapsed && (
        <div style={{overflow:'hidden'}}>
          <div style={{fontSize:12,fontWeight:600,color:C.text,whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'}}>{CLIENT.brand}</div>
          <div style={{fontSize:10,color:C.sec}}>{CLIENT.plan}</div>
        </div>
      )}
    </div>
    ...
    <nav style={{flex:1,padding:'10px',overflow:'auto'}}>
      {NAV.map(n => (
        <button key={n.id} onClick={() => navClick(n.id)} title={showCollapsed?n.label:undefined} style={{width:'100%',display:'flex',alignItems:'center',justifyContent:showCollapsed?'center':'flex-start',gap:showCollapsed?0:10,padding:showCollapsed?'10px 0':'9px 10px',borderRadius:7,border:'none',cursor:'pointer',background:active===n.id?C.redS:'transparent',color:active===n.id?C.red:C.sec,fontSize:12,fontWeight:600,fontFamily:'inherit',borderLeft:active===n.id?`2px solid ${C.red}`:'2px solid transparent',transition:'all 0.15s',textAlign:'left',marginBottom:1,whiteSpace:'nowrap'}}>
          <Icon name={n.icon} size={14} color={active===n.id?C.red:C.sec}/>
          {!showCollapsed && n.label}
        </button>
      ))}
    </nav>

    <div style={{padding:showCollapsed?'12px 0':'12px 14px',borderTop:`1px solid ${C.border}`}}>
      <button onClick={() => setDemo(!isDemo)} title={showCollapsed?(isDemo?'Mode Démo actif':'VOIR DEMO'):undefined} style={{width:'100%',display:'flex',alignItems:'center',justifyContent:'center',gap:showCollapsed?0:7,padding:'8px',borderRadius:7,background:isDemo?C.redS:'rgba(255,255,255,0.07)',border:`1px solid ${isDemo?'rgba(45,127,249,0.28)':C.border}`,color:isDemo?C.red:C.sec,fontSize:11,fontWeight:600,cursor:'pointer',fontFamily:'inherit',marginBottom:showCollapsed?0:10,whiteSpace:'nowrap'}}>
        {isDemo
          ? (<><Icon name="bolt" size={12} color={C.red}/> {!showCollapsed && 'Mode Démo actif'}</>)
          : (<><Icon name="image" size={12} color={C.sec}/> {!showCollapsed && 'VOIR DEMO'}</>)}
      </button>
      {!showCollapsed && (
        <div style={{padding:'13px',borderRadius:8,background:'rgba(45,127,249,0.10)',border:'1px solid rgba(45,127,249,0.24)',marginTop:10}}>
          <div style={{fontSize:11,color:C.red,fontWeight:700,marginBottom:3}}>Conversion Pro</div>
          <div style={{fontSize:10,color:C.sec,lineHeight:1.4,marginBottom:7}}>18 créatives/sem · Assistant IA 7j/7</div>
          <div style={{fontSize:15,color:C.text,fontWeight:700,marginBottom:9}}>64 900 FCFA<span style={{fontSize:10,fontWeight:400,color:C.sec}}>/mois</span></div>
          <button style={{width:'100%',padding:'8px',borderRadius:6,border:'none',background:C.red,color:'#fff',fontSize:11,fontWeight:700,cursor:'pointer',fontFamily:'inherit',display:'flex',alignItems:'center',justifyContent:'center',gap:6}}>
            Upgrader <Icon name="arrow" size={12} color="#fff"/>
          </button>
        </div>
      )}
    </div>
...
const Produits = ({products, setProducts}) => {
  ...
  const requestCreatives = (p) => {
    const qty = PLAN_QUANTITY[CLIENT.plan] || 9;
    setBrief({
      client: CLIENT.brand,
      plan: CLIENT.plan,
  ...
  const Field = ({label, k, required, textarea, placeholder, type='text'}) => {
    const err = errors[k];
    const common = {
      value: form[k] || '',
      onChange: e => setForm(f=>({...f,[k]:e.target.value})),
      placeholder: placeholder || '',
      style:{width:'100%',padding:'10px 12px',borderRadius:7,background:'rgba(255,255,255,0.07)',border:`1px solid ${err?C.red:C.border}`,color:C.text,fontSize:12,fontFamily:'inherit',outline:'none',resize:'vertical'},
    };
    return (
      <div>
        ...
        <div onClick={() => setShowForm(false)} style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.8)',zIndex:300,display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
          <div onClick={e=>e.stopPropagation()} style={{width:'100%',maxWidth:560,maxHeight:'88vh',overflow:'auto',borderRadius:14,background:C.card,border:`1px solid ${C.borderM}`,padding:'24px'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              <Field label="Nom du produit" k="nom" required placeholder="Ex : Sérum Éclat Intense"/>
              <div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':'1fr 1fr',gap:12}}>
                <Field label="Pricing (prix actuel)" k="pricing" required placeholder="Ex : 12 900 FCFA"/>
                <Field label="Offre promotionnelle en cours" k="promo" placeholder="Ex : -20% jusqu'au 30 juin"/>
              </div>
              <Field label="Lien de la page produit" k="lien" placeholder="https://..."/>
              <Field label="Utilité principale" k="utilite" required textarea placeholder="À quoi sert ce produit, quel problème il résout..."/>
              <Field label="Cible principale" k="cible" required textarea placeholder="Qui achète ce produit (âge, profil, besoin)..."/>
              <div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':'1fr 1fr',gap:12}}>
                <Field label="Pays de vente" k="pays" required placeholder="Ex : Sénégal"/>
                <div>
              ...
              <Field label="Contexte additionnel" k="notes" textarea placeholder="Tout autre détail utile pour la création (ton, contraintes, mentions légales...)"/>
            </div>
    ...
    <div>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:18}}>
        <div>
          ...
          <p style={{fontSize:13,color:C.sec,marginTop:3,marginBottom:0}}>{CLIENT.total} visuels produits</p>
        </div>
...
const Marche = ({products, isDemo}) => {
  ...
  <div>
    <div style={{marginBottom:18}}>
      ...
      <p style={{fontSize:13,color:C.sec,marginTop:3,marginBottom:0}}>Data collectée et applicable à vos campagnes · {CLIENT.brand}</p>
    </div>
...
const Amina = () => {
  const [msgs, setMsgs] = useState([
    {role:'assistant',content:"Bonjour ! Je suis Amina, votre conseillère IA AdStack. Je connais vos créatives, vos stats Meta et votre marché. Comment puis-je vous aider aujourd'hui ?"}
  ]);
    ...
    try {
      const res = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body:JSON.stringify({
          ...
          max_tokens:600,
          system:`Tu es Amina, conseillère IA d'AdStack. Tu assistes ${CLIENT.brand} (${CLIENT.plan}).

Données client :
- 63 créatives livrées · 9 créatives/semaine
- CTR moyen : 3.1% (↑ +0.6% vs mois précédent)
- CPM moyen : 340 FCFA
- Meilleur angle : "Douleur sociale" → 3.4% CTR
- Angle moyen : "Transformation rapide" → 2.8% CTR
- Angle faible : "Preuve sociale" → 2.1% CTR
- Produit : Sérum Éclat Intense · Marché : Dakar, Sénégal
- Paiements acceptés : Wave, Orange Money

Tu peux :
1. Interpréter les stats et donner des recommandations concrètes
2. Expliquer CTR, CPM, ROAS simplement
3. Suggérer des optimisations de campagne
4. Proposer naturellement un upgrade si pertinent : Conversion Pro = 64 900 FCFA/mois → 18 créatives/semaine, Assistant IA 7j/7

Réponds toujours en français. Maximum 4 phrases. Direct, chaleureux, professionnel.`,
          messages: newMsgs.map(m => ({role:m.role, content:m.content})),
        }),
      });
      const data = await res.json();
      setMsgs(prev => [...prev, {role:'assistant', content:data.content?.[0]?.text || "Désolée, une erreur s'est produite."}]);
    } catch {
      setMsgs(prev => [...prev, {role:'assistant', content:"Une erreur s'est produite. Réessayez dans un instant."}]);
    } finally {
      setLoading(false);
    }
  };

  const suggestions = ['Pourquoi mon CPM est élevé ?','Quel angle tester cette semaine ?','Comment améliorer mon CTR ?','Explique-moi le ROAS'];

  return (
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:16,flexShrink:0}}>
        <div style={{width:36,height:36,borderRadius:'50%',background:`linear-gradient(135deg,${C.red},#0B3D91)`,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
          <Icon name="sparkle" size={16} color="#fff"/>
        </div>
        <div>
          <h1 style={{fontSize:18,fontWeight:700,color:C.text,margin:0}}>Assistant IA</h1>
          <p style={{fontSize:11,color:C.sec,margin:0,display:'flex',alignItems:'center',gap:5}}>
            <span style={{width:6,height:6,borderRadius:'50%',background:C.red,display:'inline-block'}}/>
            Disponible · Connectée à vos données
          </p>
        </div>
      </div>

      <div style={cs({flex:1,overflow:'auto',padding:'16px',marginBottom:10,display:'flex',flexDirection:'column',gap:12})}>
        {msgs.map((m,i) => (
          <div key={i} style={{display:'flex',justifyContent:m.role==='user'?'flex-end':'flex-start',alignItems:'flex-start',gap:8}}>
            {m.role==='assistant' && (
              <div style={{width:26,height:26,borderRadius:'50%',flexShrink:0,background:`linear-gradient(135deg,${C.red},#0B3D91)`,display:'flex',alignItems:'center',justifyContent:'center',marginTop:2}}>
                <Icon name="sparkle" size={12} color="#fff"/>
              </div>
            )}
            <div style={{maxWidth:'75%',padding:'10px 14px',borderRadius:10,background:m.role==='user'?C.red:'rgba(255,255,255,0.05)',color:C.text,fontSize:12,lineHeight:1.65,borderBottomRightRadius:m.role==='user'?2:10,borderBottomLeftRadius:m.role==='assistant'?2:10}}>
              {m.content}
            </div>
          </div>
        ))}
        {loading && (
          <div style={{display:'flex',alignItems:'flex-start',gap:8}}>
            <div style={{width:26,height:26,borderRadius:'50%',flexShrink:0,background:`linear-gradient(135deg,${C.red},#0B3D91)`,display:'flex',alignItems:'center',justifyContent:'center'}}>
              <Icon name="sparkle" size={12} color="#fff"/>
            </div>
            <div style={{padding:'12px 16px',borderRadius:10,background:'rgba(255,255,255,0.05)'}}>
              <div style={{display:'flex',gap:5,alignItems:'center'}}>
                {[0,1,2].map(j => (<div key={j} style={{width:5,height:5,borderRadius:'50%',background:C.sec,animation:`blink 1.3s ${j*0.22}s infinite`}}/>))}
              </div>
            </div>
          </div>
        )}
      ...
      {msgs.length <= 1 && (
        <div style={{display:'flex',gap:6,marginBottom:10,flexWrap:'wrap',flexShrink:0}}>
          {suggestions.map(s => (
            <button key={s} onClick={() => setInput(s)} style={{padding:'6px 12px',borderRadius:20,fontSize:11,fontWeight:500,background:'rgba(255,255,255,0.07)',border:`1px solid ${C.border}`,color:C.sec,cursor:'pointer',fontFamily:'inherit',transition:'all 0.15s'}}
      ...
      <div style={{display:'flex',gap:8,flexShrink:0}}>
        <input
          ...
          placeholder="Posez votre question à Amina..."
          style={{flex:1,padding:'11px 16px',borderRadius:8,background:'rgba(255,255,255,0.05)',border:`1px solid ${C.border}`,color:C.text,fontSize:12,fontFamily:'inherit',outline:'none'}}
          onFocus={e => e.target.style.borderColor=C.red}
          onBlur={e => e.target.style.borderColor=C.border}
        />
        <button onClick={send} disabled={loading} style={{padding:'11px 20px',borderRadius:8,border:'none',background:loading?'rgba(45,127,249,0.4)':C.red,color:'#fff',fontWeight:700,fontSize:12,cursor:loading?'not-allowed':'pointer',fontFamily:'inherit',transition:'background 0.2s'}}>
          Envoyer
        </button>
      </div>
    </div>
...
const PLANS = [
  {
    ...
    current: CLIENT.plan === 'Conversion Starter',
    features:[
  ...
  },
  {
    ...
    current: CLIENT.plan === 'Conversion Pro',
    features:[
  ...
  },
  {
    ...
    current: CLIENT.plan === 'Conversion Scale',
    features:[
...
const DemoPreview = ({slug}) => {
  ...
  return (
    <div style={{height:'100%',display:'flex',flexDirection:'column',gap:0}}>
      <div style={{flexShrink:0,padding:'14px 20px',display:'flex',alignItems:'center',justifyContent:'space-between',gap:12,borderBottom:`1px solid ${C.border}`}}>
        <div>
          <div style={{fontSize:16,fontWeight:700,color:C.text}}>Votre démonstration AdStack</div>
          <div style={{fontSize:12,color:C.sec,marginTop:2}}>Analyse de marché • Persona cible • Créatives Meta Ads</div>
        </div>
        <a href={demoUrl} target="_blank" rel="noopener noreferrer" style={{fontSize:11,color:C.red,textDecoration:'none',padding:'6px 12px',borderRadius:6,border:`1px solid rgba(45,127,249,0.3)`,display:'flex',alignItems:'center',gap:5}}>
          <Icon name="arrow" size={12}/> Ouvrir en plein écran
        </a>
      </div>
      <iframe
        src={`${demoUrl}.html`}
        style={{flex:1,border:'none',width:'100%',borderRadius:'0 0 0 0'}}
        title="Démo AdStack"
        allow="fullscreen"
      />
    </div>
...
export default function App() {
  ...
  // Détecter ?demo=slug dans l'URL au chargement
  useEffect(() => {
  ...
  const views = {
    ...
    galerie: <Galerie products={products} isDemo={isDemo}/>,
    copies: <Copies products={products}/>,
    marche: <Marche products={products} isDemo={isDemo}/>,
    amina: <Amina/>,
    tarifs: <Tarifs/>,
  };
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'100vh',overflow:'hidden',background:C.bg,fontFamily:"'Outfit',sans-serif",color:C.text,WebkitFontSmoothing:'antialiased',MozOsxFontSmoothing:'grayscale'}}>
      {isDemo && (
        <div style={{flexShrink:0,background:`linear-gradient(90deg,${C.red},#1450B8)`,padding:isMobile?'8px 14px':'9px 22px',display:'flex',flexWrap:'wrap',justifyContent:'space-between',alignItems:'center',gap:8,fontSize:isMobile?11:12,fontWeight:600,color:'#fff'}}>
          <span style={{display:'flex',alignItems:'center',gap:8}}>
            <Icon name="bolt" size={13} color="#fff"/>
            {isMobile ? 'Mode Démo — Aperçu limité' : 'Mode Démo — Aperçu limité · Abonnez-vous pour débloquer toutes les fonctionnalités'}
          </span>
          <button onClick={() => setIsDemo(false)} style={{background:'rgba(255,255,255,0.2)',border:'none',color:'#fff',padding:'4px 12px',borderRadius:5,cursor:'pointer',fontSize:11,fontFamily:'inherit',display:'flex',alignItems:'center',gap:5,flexShrink:0}}>
            Quitter <Icon name="x" size={11} color="#fff"/>
          </button>
        </div>
      )}

      {isMobile && (
        <div style={{height:50,flexShrink:0,background:C.sidebar,borderBottom:`1px solid ${C.border}`,display:'flex',alignItems:'center',gap:10,padding:'0 14px'}}>
          <button onClick={() => setMobileOpen(true)} title="Ouvrir le menu" style={{width:32,height:32,borderRadius:7,border:'none',background:'rgba(255,255,255,0.05)',color:C.sec,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
            <Icon name="menu" size={15} color={C.sec}/>
          </button>
          <div style={{width:24,height:24,borderRadius:6,background:`linear-gradient(135deg,${C.red},#0B3D91)`,display:'flex',alignItems:'center',justifyContent:'center',fontSize:11,fontWeight:800,color:'#fff',flexShrink:0}}>A</div>
          <span style={{fontSize:13,fontWeight:800,color:C.text}}>AdStack</span>
          <span style={{fontSize:11,color:C.sec,marginLeft:'auto',whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis',maxWidth:130}}>
      ...
      <div style={{display:'flex',flex:1,overflow:'hidden',position:'relative'}}>
        ...
        <main style={{flex:1,overflow:'auto',padding:isMobile?'16px':'28px 30px'}}>
          {views[section]}
        </main>
      </div>
      ...
      {section !== 'amina' && (
        <button
          onClick={() => setSection('amina')}
          style={{position:'fixed',bottom:isMobile?16:22,right:isMobile?16:22,zIndex:50,width:isMobile?44:46,height:isMobile?44:46,borderRadius:'50%',border:'none',cursor:'pointer',background:`linear-gradient(135deg,${C.red},#0B3D91)`,boxShadow:'0 6px 20px rgba(45,127,249,0.45)',transition:'transform 0.2s, box-shadow 0.2s',display:'flex',alignItems:'center',justifyContent:'center'}}
          onMouseEnter={e=>{e.currentTarget.style.transform='scale(1.12)';e.currentTarget.style.boxShadow='0 8px 28px rgba(45,127,249,0.6)';}}
          onMouseLeave={e=>{e.currentTarget.style.transform='scale(1)';e.currentTarget.style.boxShadow='0 6px 20px rgba(45,127,249,0.45)';}}
        ><Icon name="sparkle" size={19} color="#fff"/></button>
      )}
    </div>
  );
}
